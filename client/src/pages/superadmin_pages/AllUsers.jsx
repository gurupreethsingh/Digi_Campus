            ...
            <div className="space-y-4">
              {filteredUsers.map((user) => (
                <Link
                  key={user._id}
                  to={`/single-user/${user._id}`}
                  className="flex flex-wrap sm:flex-nowrap items-center bg-white rounded-lg shadow p-3 relative gap-2 sm:gap-4"
                >
                  <img
                    src={getImageUrl(user.avatar, user.role)}
                    alt={user.name}
                  ...
                  <div className="flex flex-wrap sm:flex-nowrap items-center gap-2 sm:gap-4 text-sm sm:text-base font-medium text-gray-800">
