...
export default function Header() {
  ...
  const navLinks = useMemo(() => {
    ...
    if (isLoggedIn) {
      return [...commonLinks, { path: dashboardRoute, name: "Dashboard" }];
    } else {
      return [
        ...commonLinks,
        { path: "/superadmin-login", name: "Superadmin" },
        { path: "/teacher-login", name: "Teacher" },
        { path: "/student-login", name: "Student" },
      ];
    }
